...
public class RedisBlpopDemoTest {

    @Test
    public void name() throws IOException {
        Logger logger = Logger.getLogger(RedisBlpopDemo.class.getCanonicalName());
    ...
    public void config() throws IOException {
        ...
        logManager.readConfiguration(RedisBlpopDemoTest.class.getClassLoader()
                .getResourceAsStream("logging.properties"));

        Logger logger = Logger.getLogger(RedisBlpopDemoTest.class.getCanonicalName());
